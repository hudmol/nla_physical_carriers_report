...
if subjects.empty?
  Log.error("ERROR: nla_physical_carriers_report plugin is badly configured! It has no subjects. Use AppConfig[:nla_physical_carriers_report_subjects] to set an array of subjects, or don't set it to accept the default: ['born digital', 'audio', 'moving images']")
